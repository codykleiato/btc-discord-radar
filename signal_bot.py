...
def send_tradingview_signal(data):
    ...
    if (
        "BUY" in action_upper
        or "UP" in action_upper
    ):

        title = "🟢 BTC BUY / UP SIGNAL"

    elif (
        "SELL" in action_upper
        or "DOWN" in action_upper
    ):

        title = "🔴 BTC SELL / DOWN SIGNAL"

    else:

        title = "⚪ BTC TRADINGVIEW SIGNAL"
...
def start_server():
    ...
    print(
        f"Webhook server running on port {PORT}"
    )
...
# ============================================================
# ORIGINAL BINANCE RADAR
# ============================================================

def run_binance_radar():
    ...
    if current_volume > average_volume:
        ...
        if closes[-1] > closes[-2]:
            ...
            reasons.append(
                "❤️ Volume confirms downward move"
            )
    ...
    if price > day_high:
        ...
        reasons.append(
            "❤️ Price below previous-day low"
        )
    ...
    embed = {
        ...
        "footer": {
            "text":
                "PKLA Signal Hub • RSI • MACD • EMA • Volume"
        },
